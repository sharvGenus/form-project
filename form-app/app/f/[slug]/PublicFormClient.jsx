...
export default function PublicFormClient({ slug }) {
  ...
  if (redirecting) {
    return (
      <div className="min-h-screen bg-[#0b0b0f] px-4 py-16 text-white">
        <div className="mx-auto max-w-xl">
          <div className="rounded-[28px] border border-red-400/20 bg-red-500/10 p-8 text-center shadow-2xl shadow-black/30">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-red-400/25 bg-red-500/15">
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="mt-6 flex items-center justify-center gap-2">
              <span className="h-2 w-2 animate-bounce rounded-full bg-red-300/70 [animation-delay:-0.3s]" />
              <span className="h-2 w-2 animate-bounce rounded-full bg-red-300/80 [animation-delay:-0.15s]" />
